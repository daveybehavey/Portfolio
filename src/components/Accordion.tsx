      ...
      {items.map((it, idx) => {
        ...
        return (
          <details
            key={`faq-${idx}`}
            open={isOpen}
            className="group rounded-2xl border border-slate-200/85 bg-white/95 shadow-sm shadow-slate-900/[0.05] transition-colors open:border-slate-300/90 open:shadow-md open:shadow-slate-900/[0.06]"
            onToggle={(e) => {
